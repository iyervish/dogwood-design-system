    ...
    >
      {title && (
        ...
        >
          ...
          <div className="flex items-center gap-1">
            <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--shenandoah-400)' }} />
            <span className="text-[10px]" style={{ color: 'var(--shenandoah-500)' }}>Live</span>
          </div>
        </div>
      )}
      ...
      >
        <button
          ...
          style={{
            color: showCode ? 'var(--dogwood-700)' : 'var(--color-text-muted)',
            backgroundColor: showCode ? 'var(--dogwood-100)' : 'transparent',
          }}
        >
