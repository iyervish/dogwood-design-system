  ...
  if (!item.children) {
    return (
      <Link
        ...
        style={{
          color: isActive ? 'var(--blue-ridge-950)' : 'var(--color-text-secondary)',
          backgroundColor: isActive ? 'var(--dogwood-100)' : 'transparent',
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  backgroundColor: childActive ? 'var(--dogwood-100)' : 'transparent',
                  borderLeft: childActive ? '2px solid var(--dogwood-500)' : '2px solid transparent',
                  fontFamily: 'var(--font-body)',
                }}
              >
                {child.label}
...
export default function Sidebar({ open, onClose }: SidebarProps) {
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 z-40 h-full overflow-y-auto dogwood-scrollbar
