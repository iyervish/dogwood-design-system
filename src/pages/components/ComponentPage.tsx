      ...
      <div className="dogwood-prose">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <span
            ...
            style={{
              backgroundColor: meta.status === 'stable' ? 'var(--shenandoah-100)' : 'var(--dogwood-100)',
              color: meta.status === 'stable' ? 'var(--shenandoah-600)' : 'var(--dogwood-700)',
            }}
          >
            {meta.status}
          </span>
        ...
        <CodeBlock
          ...
          code={`import { ${meta.name} } from '@dogwood/components/${meta.name}';`}
        />
        {registry.usageCode && (
          <div className="mt-4">
        ...
        <div
          ...
          style={{ borderColor: 'var(--shenandoah-200)', backgroundColor: 'var(--shenandoah-50)' }}
        >
          <div className="flex items-center gap-2 mb-3">
            <span
              className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full"
              style={{ backgroundColor: 'var(--shenandoah-200)', color: 'var(--shenandoah-700)' }}
            >
              WCAG 2.1 AA
            </span>
          </div>
