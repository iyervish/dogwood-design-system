...
const foundations = [
  {
    title: 'Principles',
    description: 'The core design principles that guide every decision in the Dogwood design system.',
    icon: Sparkles,
    href: '/foundations/principles',
    accent: 'var(--dogwood-100)',
    accentIcon: 'var(--dogwood-600)',
  },
  {
    title: 'Color',
    description: 'Virginia-inspired color system with a 3-layer token architecture.',
    icon: Palette,
    href: '/foundations/color',
    accent: 'var(--blue-ridge-100)',
    accentIcon: 'var(--blue-ridge-600)',
  },
  {
    title: 'Typography',
    ...
    accent: 'var(--chesapeake-100)',
    accentIcon: 'var(--chesapeake-600)',
  },
  {
    title: 'Spacing',
    ...
    accent: 'var(--shenandoah-100)',
    accentIcon: 'var(--shenandoah-600)',
  },
  {
    title: 'Elevation',
    ...
    accent: 'var(--cardinal-100)',
    accentIcon: 'var(--cardinal-500)',
  },
  {
    title: 'Motion',
    ...
    accent: 'var(--piedmont-100)',
    accentIcon: 'var(--piedmont-500)',
  },
];
  ...
  return (
    <div className="dogwood-prose">
      ...
      <p className="text-lg" style={{ color: 'var(--color-text-secondary)' }}>
        The building blocks of the Dogwood design system. These tokens and principles
        ...
        {foundations.map(item => {
          ...
          return (
            <Link
              ...
              onMouseEnter={e => {
                (e.currentTarget as HTMLElement).style.borderColor = 'var(--dogwood-300)';
